...
<div class="relative w-full bg-gray-100 py-16 px-4">
	<div class="max-w-7xl mx-auto">
		...
		<div class="flex items-center justify-between">
			<!-- Previous Button -->
			<button
				class="bg-white rounded-full shadow-sm border border-gray-200 p-3 flex items-center justify-center z-10 w-12 h-12 hover:shadow-md transition-shadow duration-200 flex-shrink-0 mr-4 lg:mr-8"
				onclick={() => {
					prev();
					pauseAuto();
				}}
			...
			<div class="flex-1 relative overflow-hidden">
				...
				<div class="block lg:hidden">
					<div class="flex justify-center">
						<div
							class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 w-full max-w-sm min-h-[280px] flex flex-col justify-between transition-all duration-500 ease-in-out"
				...
				<div class="hidden lg:block">
					<div class="flex items-stretch justify-center gap-6 xl:gap-8">
			...
			<!-- Next Button -->
			<button
				class="bg-white rounded-full shadow-sm border border-gray-200 p-3 flex items-center justify-center z-10 w-12 h-12 hover:shadow-md transition-shadow duration-200 flex-shrink-0 ml-4 lg:ml-8"
				onclick={() => {
					next();
					pauseAuto();
				}}
			...
			{#each testimonials as _, i}
				<button
					class="transition-all duration-300 rounded-full
						{i === active ? 'w-8 h-2 bg-gray-800' : 'w-2 h-2 bg-gray-300'}"
					onclick={() => {
						goTo(i);
						pauseAuto();
					}}
